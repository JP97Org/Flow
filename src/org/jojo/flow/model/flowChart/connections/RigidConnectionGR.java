...
public class RigidConnectionGR extends ConnectionGR {
    ...
    public void restoreFromDOM(final DOM dom) {
        if (isDOMValid(dom)) {
            ...
            final RigidPinGR fromPin = (RigidPinGR)DynamicClassLoader.loadGR(cn);
            ...
            for (final var conObj : connectionsMap.values()) {
                ...
                final OneConnectionGR con = (OneConnectionGR) DynamicClassLoader.loadGR(OneConnectionGR.class.getName(), false);
    ...
    public boolean isDOMValid(final DOM dom) {
        ...
        try {
            ...
            final RigidPinGR fromPin = ok(c -> (RigidPinGR) DynamicClassLoader.loadGR(c), cnFrom);
            ...
            for (final var conObj : connectionsMap.values()) {
                ...
                final DOM conDom = (DOM)conObj;
                final OneConnectionGR con = ok(d -> (OneConnectionGR) DynamicClassLoader.loadGR(OneConnectionGR.class.getName(), false), "");

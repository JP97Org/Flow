...
/**
 * Represents a basic checkable {@link IData}, i.e. a data which is not recursive in its nature, 
 * i.e. it usually does not contain other {@link IData} as data.
 * 
...
public interface IBasicCheckable extends IData {
    ...
    /**
     * 
     * @return the {@link UnitSignature} or {@code null} if this data does not have a unit signature
     */
    UnitSignature getUnitSignature();
    
    /**
     * 
     * @return the {@link BasicType} or {@code null} if this data does not have a basic type
     */
